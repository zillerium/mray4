      ...
      <main className="min-h-screen px-8 py-0 pb-12 flex-1 flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full mt-8">
          <div className="flex-1 bg-gray-200 p-6 rounded-lg shadow-md">
            ...
            <p className="mt-4 text-base">Valuations are independently done by investors who have staked in the Mray project.</p>
            <br />
...
<div>
            ...
            <div className="flex-1 bg-gray-200 p-6 rounded-lg shadow-md">
                ...
                <ReadNftByTokenNumberOwner
                   tokenNumber={selectedToken.toString()}
                    ...
                    onNftLockedStatus={(lockedStatus) => setNftLockedStatus(lockedStatus ?? false)} // Map null to false
                 />
             <div className="mt-4">
        ...
        <div className="w-full">
          ...
          {selectedToken !== null && isConnected && nftOwner !== null && (
            <>
              <VeVotesCastBal nftOwner={nftOwner} nftId={selectedToken} onVotesCastChange={() => {}} />
            </>
          )}
        </div>
        <hr className="w-full border-t border-gray-300 my-6" />
