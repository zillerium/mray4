  ...
  return (
    <div className="flex-1 bg-gray-200 p-6 rounded-lg shadow-md flex justify-center items-center">
      ...
      >
        ...
        <text x="125" y="80" textAnchor="middle" fontSize="18" fill="#230b59" fontWeight="bold">
          Total Liquidity
        </text>
        <text x="125" y="110" textAnchor="middle" fontSize="24" fill="#230b59" fontWeight="bold">
          ${totalCounter.toLocaleString()} USD
        </text>

        {/* Lamborghini Counter */}
        <text x="50" y="220" fontSize="12" fill="#230b59" fontWeight="bold">Lamborghini</text>
        <text x="190" y="220" textAnchor="end" fontSize="12" fill="#230b59" fontWeight="bold">
          ${lamboCounter.toLocaleString()}
        </text>

        {/* Ferrari Counter */}
        <text x="50" y="270" fontSize="12" fill="#230b59" fontWeight="bold">Ferrari</text>
        <text x="190" y="270" textAnchor="end" fontSize="12" fill="#230b59" fontWeight="bold">
          ${ferrariCounter.toLocaleString()}
        </text>

        {/* McLaren Counter */}
        <text x="50" y="320" fontSize="12" fill="#230b59" fontWeight="bold">McLaren</text>
        <text x="190" y="320" textAnchor="end" fontSize="12" fill="#230b59" fontWeight="bold">
